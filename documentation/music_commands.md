...
*These commands referenced here have different names than the target ones. Most of the documentation still applies. See command_to_byte_size.md for more details on how much space each command uses.*

*This documentation was originally retrieved from [here](https://github.com/pret/pokecrystal/blob/master/docs/music_commands.md).*
...
*Also see the [legacy commands](https://github.com/pret/pokecrystal/blob/master/macros/legacy.asm) which are used by this program.*
